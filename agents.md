# AGENTS.md — 芒格计划·思维模式篇

## 项目概述

思维模式篇是芒格计划的姊妹系列。核心思路：**用"学科季"模式，像物理学家、经济学家、历史学家……一样思考**。每季聚焦一个学科，每季 4 期，每期讲透该学科的一种底层思维习惯。目标是用大白话说清楚"像XX家一样思考"到底意味着什么。
...
两个系列**互补不重复**：芒格计划是格栅的横线，思维模式篇是格栅的纵线。
...
1. **hero** — 学科色光晕（deep wine + discipline accent）
   - `.hero-badge`：必须包含阿拉伯数字 "思维模式篇 · 第X期"
